...
spawner.AddSpawnerEntry(5, Eyer, bg_up, 8);
spawner.AddSpawnerEntry(5, Eyer, bg_down, 8);
...
//Wave 7
spawner.AddSpawnerEntry(6, Eyer, bg_up, 1);
spawner.AddSpawnerEntry(6, Eyer, bg_down, 2);
spawner.AddSpawnerEntry(6, Eyer, bg_middle, 3);
