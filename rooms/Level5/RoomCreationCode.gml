...
spawner.AddSpawnerEntry(1, TestEnemy, bg_rightUp, 2);
...
spawner.AddSpawnerEntry(2, TestEnemy, bg_left, 2);
...
spawner.AddSpawnerEntry(2, TestEnemy, bg_right, 5);
...
spawner.AddSpawnerEntry(3, TestEnemy, bg_middle, 4);
spawner.AddSpawnerEntry(3, TestEnemy, bg_right, 6);
